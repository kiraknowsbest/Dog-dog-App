			...
			if (!!this.state.text.trim()) {
				axios({
					...
					.then(function (response) {
						let post = Object.assign({}, app.props.currentPost)
						post.comments.push(response.data)
						app.props.changeCurrentPostToStore(post)
						app.__commentBox.value = ''
					})
						...
						(
							<div>
								...
								<div className='full-width'>
									...
									<div className='full-width'>
										{
											this.props.currentPost.comments.map((comment,i) => {
												return(
													<div comment={comment} key={i} className='comment-box full-width'>
									...
									<textarea ref={el => this.__commentBox = el} className='comment-textarea' rows="4" cols="50" onChange={this.getText} /><br/>
